                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                   ...
                                   {product.cartQuantity===0 && <button
                                     ...
                                     onClick={()=>this.props.addToCartItem(i)}
                                     >
                                        Add To Cart
                                    </button>}

                                   { product.cartQuantity>=1 && <div className="layout-row justify-content-between align-items-center">
                                        <button 
                                        ...
                                        <button 
                                         onClick={()=>this.props.increseItem(product.id)}
                                        className="x-small icon-only outlined"
